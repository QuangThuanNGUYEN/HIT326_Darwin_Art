        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="/" class="font-bold text-lg">Darwin Art</a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="mt-3 space-y-1 px-4">
                <a href="{{ route('login') }}" class="block text-sm text-gray-700 py-2">Login</a>
                <a href="{{ route('register') }}" class="block text-sm text-gray-700 py-2">Register</a>
            </div>
        </div>
        @endauth
    </div>
